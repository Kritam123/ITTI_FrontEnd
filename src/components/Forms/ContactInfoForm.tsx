...
const formSchema = z.object({
  ...
  vatNumber: z.string().min(2, { message: "Please give proper email" }),
...
const ContactInfoForm = ({ setOpen }: { setOpen: (open: boolean) => void }) => {
  const [createAddress,{isError,error,data,isLoading,isSuccess}] = useCreateAddressMutation();
